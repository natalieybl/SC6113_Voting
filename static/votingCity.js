...
const contractAddress = "0x32600037E386751FF9A3b0A8c1218EA0b4779730"; // Replace with the deployed contract address
...
document.getElementById('showWinnerButton').addEventListener('click', async () => {
	try {
		...
		const winningText = `
				...
				<p><strong>${winningProposal.description}</strong> is the most beautiful city with a total of <strong>${winningProposal.voteCount} votes</strong>.</p>
